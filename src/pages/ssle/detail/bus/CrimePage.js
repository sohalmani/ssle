      ...
      <Grid item xs={12}>
        <Stack spacing={1} align="right">
          <Stack spacing={1} direction="row" justifyContent="flex-end">
            <a
              href="https://www.figma.com/proto/SIIquflUf9Uzq2uSWcc464/SSLE?type=design&node-id=274-23701&t=SqbBAjjPMcZ8A6ld-1&scaling=scale-down&page-id=114%3A2955"
              target="_blank"
              rel="noreferrer"
            >
              <Button variant="outlined" onClick={handlePublishClick}>
                Preview
              </Button>
            </a>
