      ...
      <Grid item xs={12}>
        <Stack spacing={1} align="right">
          <Stack spacing={1} direction="row" justifyContent="flex-end">
            <a
              href="https://www.figma.com/proto/SIIquflUf9Uzq2uSWcc464/SSLE?type=design&node-id=274-25597&t=SqbBAjjPMcZ8A6ld-1&scaling=scale-down&page-id=114%3A2955"
              target="_blank"
              rel="noreferrer"
            >
                ...
                <TableCell align="right">
                  <Stack spacing={1} direction="row" justifyContent="flex-end">
                    <Button
                      variant="outlined"
                      color="warning"
                      onClick={() => handleEditClick('Male', 'Lorem ipsum dolor sit amet consectetur adipisicing elit.', 'MAR', '2023')}
                    >
                      Edit
                    </Button>
                  </Stack>
                ...
                <TableCell align="right">
                  <Stack spacing={1} direction="row" justifyContent="flex-end">
                    <Button
                      variant="outlined"
                      color="warning"
                      onClick={() => handleEditClick('Female', 'Lorem ipsum dolor sit amet consectetur adipisicing elit.', 'JUN', '2023')}
                    >
                      Edit
                    </Button>
                  </Stack>
